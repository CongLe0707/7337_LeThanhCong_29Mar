...
let { SignUpValidator, LoginValidator, validate } = require('../utils/validator'); // Import validators

router.post('/signup', SignUpValidator, validate, async function (req, res, next) { // Add validation middleware
    try {
...
router.post('/login', LoginValidator, validate, async function (req, res, next) { // Add validation middleware
    try {
...
router.post('/change_password', check_authentication, validate, async function (req, res, next) { // Add validation middleware
    try {
...
router.post('/forgotpassword', validate, async function (req, res, next) { // Add validation middleware
    try {
...
router.post('/resetpassword/:token', validate, async function (req, res, next) { // Add validation middleware
    try {
